...
class PersonalizedWorkoutPage(BasePage):
    ...
    def init_ui(self):
        ...
        muscle_options = [
            "三角肌", "三角肌中束", "三角肌后束", "肱二头肌", "肱三头肌", "肩胛稳定肌群",
            "腹直肌", "腹外斜肌", "腹内斜肌", "核心", "胸大肌", "斜方肌", "下背部",
            "臀大肌", "股四头肌", "腿后侧肌群", "小腿三头肌",
            "全身", "心肺"
        ]
        ...
        self.difficulty_input.addItems([str(i) for i in range(5, 0, -1)])
    ...
    def generate_ai_plan(self):
        ...
        try:
            ...
            target = self.muscle_input.currentText().strip()
...
"""
    ...
    def generate_regular_plan(self):
        ...
        self.generated_plan = workout_plan  # ✅ 保存到成员变量，供之后使用
    ...
    def add_plan_to_mainpage(self):
        ...
        if main_page:
            for ex in self.generated_plan:
                main_page.add_to_training_list(ex)
